...
public class ModOreGeneration {
    public static void generateOres() {
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.TIN_LARGE);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.CITRINE);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.TURQUOISE);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.TOPAZ_MEDIUM);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.TANZANITE_MEDIUM);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.TOURMALINE_MEDIUM);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.SPINEL_MEDIUM);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.RUBY_MEDIUM);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.SAPPHIRE_MEDIUM);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.MOISSANITE_MEDIUM);
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.ENDERITE_SMALL);
        BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(),
                GenerationStep.Feature.UNDERGROUND_ORES, ModPlacedFeatures.ENDERITE_LARGE);
    }
}