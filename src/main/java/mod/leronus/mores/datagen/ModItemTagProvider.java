...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(ItemTags.SWORDS).add(
                ...
                ModItems.AMETHYST_SWORD, ModItems.TOPAZ_SWORD, ModItems.TOURMALINE_SWORD, ModItems.EMERALD_SWORD,
                ModItems.RUBY_SWORD, ModItems.SAPPHIRE_SWORD, ModItems.SPINEL_SWORD, ModItems.CITRINE_SWORD,
                ModItems.MOISSANITE_SWORD, ModItems.ONYX_SWORD, ModItems.OBSIDIAN_SWORD, ModItems.GRAPHENE_SWORD);
        getOrCreateTagBuilder(ItemTags.PICKAXES).add(
                ModItems.TIN_PICKAXE, ModItems.COPPER_PICKAXE, ModItems.SILVER_PICKAXE, ModItems.BRONZE_PICKAXE, ModItems.COBALT_PICKAXE,
                ModItems.STERLING_SILVER_PICKAXE, ModItems.ROSE_GOLD_PICKAXE, ModItems.CARBON_STEEL_PICKAXE, ModItems.HARDENED_STEEL_PICKAXE, ModItems.AMETHYST_PICKAXE, ModItems.EMERALD_PICKAXE, ModItems.OBSIDIAN_PICKAXE,
                ModItems.TOPAZ_PICKAXE, ModItems.TOURMALINE_PICKAXE, ModItems.CITRINE_PICKAXE, ModItems.RUBY_PICKAXE, ModItems.SAPPHIRE_PICKAXE, ModItems.SPINEL_PICKAXE,
                ModItems.MOISSANITE_PICKAXE, ModItems.TURQUOISE_PICKAXE, ModItems.ONYX_PICKAXE, ModItems.GRAPHENE_PICKAXE);
        getOrCreateTagBuilder(ItemTags.SHOVELS).add(
                ...
                ModItems.MOISSANITE_SHOVEL, ModItems.TURQUOISE_SHOVEL, ModItems.ONYX_SHOVEL, ModItems.GRAPHENE_SHOVEL);
        getOrCreateTagBuilder(ItemTags.AXES).add(
                ...
                ModItems.CARBON_STEEL_AXE, ModItems.HARDENED_STEEL_AXE, ModItems.AMETHYST_AXE, ModItems.EMERALD_AXE, ModItems.OBSIDIAN_AXE, ModItems.TOPAZ_AXE, ModItems.TOURMALINE_AXE,
                ModItems.CITRINE_AXE, ModItems.RUBY_AXE, ModItems.SAPPHIRE_AXE, ModItems.SPINEL_AXE,ModItems.MOISSANITE_AXE, ModItems.TURQUOISE_AXE, ModItems.ONYX_AXE,
        ...
        getOrCreateTagBuilder(ItemTags.HOES).add(
                ...
                ModItems.CARBON_STEEL_HOE, ModItems.HARDENED_STEEL_HOE, ModItems.AMETHYST_HOE, ModItems.EMERALD_HOE, ModItems.OBSIDIAN_HOE, ModItems.TOPAZ_HOE, ModItems.TOURMALINE_HOE,
