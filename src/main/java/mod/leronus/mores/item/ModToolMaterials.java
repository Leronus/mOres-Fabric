...
public enum ModToolMaterials implements ToolMaterial {
    ...
    HARDENED_STEEL(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 2000, 8.5F, 3.5F, 18, () -> Ingredient.ofItems(ModItems.HARDENED_STEEL_INGOT)),
    ...
    CITRINE(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 888, 9.0F, 3.5F, 19, () -> Ingredient.ofItems(ModItems.CITRINE_GEM)),
    ONYX(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 932, 8.5F, 4.0F, 14, () -> Ingredient.ofItems(ModItems.ONYX_GEM)),
    TANZANITE(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 1001, 8.5F, 3.0F, 7, () -> Ingredient.ofItems(ModItems.TANZANITE_GEM)),
    TOURMALINE(BlockTags.INCORRECT_FOR_IRON_TOOL, 1257, 7.0F, 3.0F, 16, () -> Ingredient.ofItems(ModItems.TOURMALINE_GEM)),
    TOPAZ(BlockTags.INCORRECT_FOR_IRON_TOOL, 1369, 7.0F, 3.0F, 18,  () -> Ingredient.ofItems(ModItems.TOPAZ_GEM)),
