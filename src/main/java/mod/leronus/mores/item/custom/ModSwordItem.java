...
public class ModSwordItem extends SwordItem {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        if(stack.getItem() == ModItems.AMETHYST_SWORD) {
        ...
        if(stack.getItem() == ModItems.ONYX_SWORD || stack.getItem() == ModItems.ONYX_DAGGER) {
        ...
        if(stack.getItem() == ModItems.RUBY_SWORD || stack.getItem() == ModItems.RUBY_DAGGER) {
            target.setOnFireFor(5);
        }
        //If the item is a sapphire sword, apply glowing effect on targetEntity
        if(stack.getItem() == ModItems.SAPPHIRE_SWORD || stack.getItem() == ModItems.SAPPHIRE_DAGGER) {
            target.addStatusEffect(new StatusEffectInstance(StatusEffects.GLOWING, 250, 1, false, false));
        }
        //If the item is a moissanite sword, apply poison effect on targetEntity
        if(stack.getItem() == ModItems.MOISSANITE_SWORD || stack.getItem() == ModItems.MOISSANITE_DAGGER) {
        ...
        if (!attacker.getWorld().isClient
                && (stack.getItem() == ModItems.SPINEL_SWORD || stack.getItem() == ModItems.SPINEL_DAGGER)
