...
public class ModArmorMaterials
{
    ...
    public static final RegistryEntry<ArmorMaterial> CHAINMAIL = registerArmorMaterial("chainmail",
            ...
            12, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, () -> Ingredient.ofItems(ModItems.CHAIN),List.of(new ArmorMaterial.Layer(Identifier.of(Mores.MOD_ID, "chainmail"))), 0.0f, 0.0f));
    ...
    public static final RegistryEntry<ArmorMaterial> STERLING = registerArmorMaterial("sterling",
            () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                        map.put(ArmorItem.Type.BOOTS, 2);
                        map.put(ArmorItem.Type.LEGGINGS, 5);
                        map.put(ArmorItem.Type.CHESTPLATE, 6);
            ...
            17, SoundEvents.ITEM_ARMOR_EQUIP_IRON, () -> Ingredient.ofItems(ModItems.STERLING_INGOT),List.of(new ArmorMaterial.Layer(Identifier.of(Mores.MOD_ID, "sterling"))), 0.0f, 0.0f));
    ...
    public static final RegistryEntry<ArmorMaterial> STEEL = registerArmorMaterial("steel",
            () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                        map.put(ArmorItem.Type.BOOTS, 2);
            ...
            15, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, () -> Ingredient.ofItems(ModItems.STEEL_INGOT),List.of(new ArmorMaterial.Layer(Identifier.of(Mores.MOD_ID, "steel"))), 1.0f, 0.5f));
    ...
    public static final RegistryEntry<ArmorMaterial> TANZANITE = registerArmorMaterial("tanzanite",
            ...
            18, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND,() -> Ingredient.ofItems(ModItems.TANZANITE_GEM),List.of(new ArmorMaterial.Layer(Identifier.of(Mores.MOD_ID, "tanzanite"))), 2.0f, 0.0f));
