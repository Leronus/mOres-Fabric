...
public class ModWeaponsmithTradesWeighted {
    ...
    public static Int2ObjectMap<TradeOffers.Factory[]> buildLeveledTradeMap() {
        ...
        // ==================== LEVEL 4 (3 slots) ====================
        {
            ...
            pool.add(new WeightedTrade("ENCH_BATTLE_MACE_MOISSANITE", 10,
            ...
            pool.add(new WeightedTrade("ENCH_BATTLE_MACE_SAPPHIRE", 12,
            ...
            pool.add(new WeightedTrade("ENCH_BATTLE_MACE_RUBY", 12,
            ...
            pool.add(new WeightedTrade("ENCH_BATTLE_MACE_TOURMALINE", 16,
